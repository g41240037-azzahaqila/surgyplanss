<x-app-layout>
    ...
    <section class="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
        <form method="POST" action="{{ route('nurse-regular.patients.store') }}" class="space-y-6">
            @csrf
            ...
            <div class="flex justify-end gap-3">
                <a href="{{ route('nurse-regular.patients.index') }}" class="rounded-lg border border-slate-200 px-5 py-3 text-sm font-semibold text-slate-700 hover:bg-slate-50">Batal</a>
