<x-app-layout>
    ...
    <section class="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
        <form method="POST" action="{{ route('nurse-ok.rooms.update', $room) }}" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="flex justify-end gap-3">
                <a href="{{ route('nurse-ok.rooms.show', $room) }}" class="rounded-lg border border-slate-200 px-5 py-3 text-sm font-semibold text-slate-700 hover:bg-slate-50">Batal</a>
